...
impl SyncActionServer {
    ...
    ) -> Result<tonic::Response<osprey_coordinator_sync_action::ProcessActionResponse>, tonic::Status>
    {
        ...
        // before the request is enqueued or a snowflake is allocated. Discord
        // API's gRPC client retries `Unavailable` against the mesh service,
        // which routes the retry to a healthier coordinator pod. Without this,
